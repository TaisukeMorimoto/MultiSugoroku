...
public class UltimatePlayerTest {
	...
	public static ArrayList<UltimatePlayer> initPlayer() {
		...
		System.out.println("<" + miyashita.getName() + ">"  + miyashita.getUltimateName());

		UltimatePlayer otake = new UltimatePlayer(26, 6, "Otake");
		System.out.println("<" + otake.getName() + ">"  + otake.getUltimateName());

		UltimatePlayer kano = new UltimatePlayer(26, 6, "Kano");
		System.out.println("<" + kano.getName() + ">"  + kano.getUltimateName());

		UltimatePlayer katada = new UltimatePlayer(26, 6, "Katada");
		System.out.println("<" + katada.getName() + ">"  + katada.getUltimateName());
	...
	public static void onePlay(UltimatePlayer player, SugorokuNormal sugoroku) {
		...
		System.out.println(player.getName() + "の現在の血中アルコール濃度は" + player.getBloodAlcLv() + "です。");
		sugoroku.getLiquorList();
		...
		System.out.println("現在の血中アルコール濃度は" + player.getBloodAlcLv() + "です。");
		player.doUltimate();
	}
