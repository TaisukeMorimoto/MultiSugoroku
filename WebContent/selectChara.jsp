		...
		<header>
            ...
            <div class="selection-group">
                ...
                <label for="suzuki">
                    ...
                    飲んでなくない？wowwow⤴</span>
                        <img src="image/character/suzuki/suzuki1.jpg">
                        <p>アルハラの鈴木</p>
                    </div>
                </label>
                ...
                <label for="katada">
                    <div class="futatsuna"><span class="skill"><br>必殺技<br><br>えぇ、酔ってないですよ～</span>
                        <img src="image/character/katada/katada1.jpg">
                        <p>千鳥足の堅田</p>
                    </div>
                </label>
                ...
                <label for="miyashita">
                    <div class="futatsuna">
                        ...
                        <img src="image/character/miyashita/miyashita1.jpg">
                        <p>幹事の宮下</p>
                    </div>
                </label>
                ...
                <label for="kano">
                    <div class="futatsuna"><span class="skill"><br>必殺技<br><br>今日、この後デートあるんで♡</span>
                        <img src="image/character/kano/kano1.jpg">
                        <p>断り上手の狩野</p>
                    </div>
                </label>
                ...
                <label for="otake">
                    <div class="futatsuna"><span class="skill"><br>必殺技<br><br>さよならは悲しい言葉じゃない</span>
                        <img src="image/character/otake/otake1.jpg">
                        <p>泣き上戸の大竹</p>
                    </div>
                </label>
                ...
                <label for="inoue">
                    <div class="futatsuna"><span class="skill"><br>必殺技<br><br>大丈夫ですかー！？！？</span>
                        <img src="image/character/inoue/inoue1.jpg">
                        <p>介抱の井上</p>
                    </div>
                </label>
